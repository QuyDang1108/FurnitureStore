...
public class Constants {
    ...
    public static final class Message {
        ...
        public static final String INCORRECT_USERNAME_OR_PASSWORD = "Tên tài khoản hoặc mật khẩu không đúng!";
        public static final String INCORRECT_OLD_PASSWORD = "Mật khẩu cũ không đúng!";
        public static final String DUPLICATE_OLD_NEW_PASSWORD = "Mật khẩu cũ trùng với mật khẩu mới!";
        public static final String CAN_NOT_CHANGE_PASSWORD = "Không thể thay đổi mật khẩu người dùng!";
