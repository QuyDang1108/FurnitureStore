        ...
        <div className="flex w-full h-full relative">
          ...
          >
            <div className="w-full h-[calc(100vh-177px)] bg-[#9e97e9] md:bg-transparent overflow-y-auto">
              ...
              >
                ...
                <div className="flex justify-center items-start flex-col w-full">
                  <div className="flex justify-between items-center w-full">
                    <h2 className="text-base font-semibold">Anh Thu</h2>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div className="flex justify-center items-start flex-col w-full">
                  <div className="flex justify-between items-center w-full">
                    <h2 className="text-base font-semibold">Tan Ga</h2>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div className="flex justify-center items-start flex-col w-full">
                  <div className="flex justify-between items-center w-full">
                    <h2 className="text-base font-semibold">Messi</h2>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="w-full md:w-[calc(100%-200px)] md:pl-4">
              ...
              <div className="bg-[#475569] h-[calc(100vh-290px)] rounded-md p-3 overflow-y-auto">
                <div className="w-full flex justify-start items-center">
                  <div className="flex justify-start items-start gap-2 md:px-3 py-2 max-w-full lg:max-w-[85%]">
                    ...
                    <div className="flex justify-center items-start flex-col w-full bg-blue-500 text-white py-1 px-2 rounded-sm">
            ...
            <form className="flex gap-3">
              <input
                className="w-full flex justify-between px-2 bg-[#8288ED] border border-slate-700 items-center py-[5px] focus:border-blue-500 rounded-md outline-none bg-transparent text-white placeholder:text-[#d7d5d7]"
                type="text"
